...
void loop() {
  ...
  data.Lx = map(analogRead(A6), 300, 1023, 1000, 2000); // Convert the analog read value from 0 to 1023 into a BYTE value from 0 to 255
  data.Ly = map(analogRead(A7), 0, 1023, 1000, 2000);
  data.Rx = map(analogRead(A3), 70, 1023, 1000, 2000);
  data.Ry = map(analogRead(A2), 0, 1023, 1000, 2000);
